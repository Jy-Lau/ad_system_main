...
def generate_launch_description():
    ...
    # )
    package_names = ["interior_monitoring","lane_detection","localization","v2x_receiver","environment_model","global_planning","behavior_planning","local_planning","lateral_control","longitudinal_control","v2x_transmitter"]
    nodes = []
    handlers = []
