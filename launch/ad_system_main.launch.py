...
def generate_launch_description():
    ...
    # )
    package_names = ["localization_pkg","decision_core","v2x_receiver","path_planning_pkg","control","v2x_transmitter","vehicle_visualizer","obstacle_detection"]
    node_names = ["localization_node","decision_core","v2x_receiver","path_planning_node","control","v2x_transmitter","vehicle_visualizer","obstacle_detection"]
